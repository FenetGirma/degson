// Sidebar and Main Heading Interactions
// ---------------------------------------
const sidebarLinks = document.querySelectorAll('.sidebar a');
const mainHeading = document.querySelector('h1');

// Add event listeners to update active link and main heading
    ...
    events.forEach((event, index) => {
      const row = `
        <tr>
          ...
          <td>
            <img src="http://localhost:8080${event.posterImagePath}" alt="Poster" style="width: 50px; height: auto;" />
            <br />
